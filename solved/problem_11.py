...
def product_horizontaly(number_grid: list[list[int]], grid_size: int) -> int:
    ...
    for i in range(grid_size):
        for j in range(grid_size - 3):
            product = number_grid[i][j] * number_grid[i][j+1] * number_grid[i][j+2] * number_grid[i][j + 3]
...
def product_verticaly(number_grid: list[list[int]], grid_size: int) -> int:
    ...
    for i in range(grid_size - 3):
        for j in range(grid_size):
            product = number_grid[i][j] * number_grid[i+1][j] * number_grid[i+2][j] * number_grid[i+3][j]
            biggest = max(biggest, product)
...
def product_diagonaly_down(number_grid: list[list[int]], grid_size: int) -> int:
    ...
    for i in range(grid_size - 3):
        for j in range(grid_size - 3):
            product = number_grid[i][j] * number_grid[i+1][j+1] * number_grid[i+2][j+2] * number_grid[i+3][j+3]
            biggest = max(biggest, product)
...
def main() -> None:
    ...
    max_values = [
        ...
        product_verticaly(number_grid, grid_size),
        product_diagonaly_down(number_grid, grid_size),
        product_diagonaly_up(number_grid, grid_size)
    ]
